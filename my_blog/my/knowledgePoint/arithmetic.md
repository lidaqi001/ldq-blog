...
下面是一个典型的红黑树示例：
```
![image](/my_blog/images/arithmetic/red-black-tree.jpg)
```text
...
![image](/my_blog/images/arithmetic/insert-heap.png)
...
![image](/my_blog/images/arithmetic/heap-sort-1.png)

```text
解决办法是将数组中的最后一个元素（最右边的叶子节点）移到堆顶，再重新对其进行堆化：
```

![image](/my_blog/images/arithmetic/heap-sort-2.png)
